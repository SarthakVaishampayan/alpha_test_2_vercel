...
import { User, Mail, Calendar, Trophy, Clock, CheckSquare } from "lucide-react";
    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        setStats({
          ...
          tasksCompleted: tData?.success
            ? tData.tasks.filter((t) => t.completed).length
            : 0,
          streakDays,
          ...
          <div className="col-lg-4">
            ...
            <div className="row g-3 mt-1">
              {[
                ...
                {
                  label: "Active Days",
                  value: statsLoading ? "—" : stats.streakDays,
                  color: "text-success",
                },
                {
                  label: "Tasks Done",
                ...
                {
                  label: "Habits",
                  value: statsLoading ? "—" : stats.habitsCount,
                  color: "text-danger",
                },
              ].map((s, i) => (
          ...
          <div className="col-lg-8">
            ...
            {user.bio && (
              <div className="bg-white p-4 rounded-4 shadow-sm border mb-4">
                <h6
                  className="fw-bold mb-2 text-muted text-uppercase"
                  style={{ fontSize: "11px" }}
                >
                  About Me
                </h6>
            ...
            <div className="bg-white p-4 rounded-4 shadow-sm border">
              ...
              <div className="row g-3">
                {[
                  ...
                  {
                    icon: (
                      <CheckSquare size={28} className="text-primary mb-2" />
                    ),
                    value: statsLoading ? "—" : stats.tasksCompleted,
